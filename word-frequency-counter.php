...
<head>
    ...
    <script>
        // List of common English stop words to exclude from frequency calculation
        const stopWords = [
        ...
        function calculateWordFrequency() {
            try {
                ...
                // Sort the array based on frequency or alphabetically
                switch(sortOrder) {
                    case "frequency_asc":
                ...
                // Limit the number of words displayed based on user input
        ...
        /**
         * Generates a bar chart using Chart.js to visualize word frequencies.
        ...
        /**
         * Downloads the word frequency results as a CSV file.
         */
        ...
        /**
         * Disables or enables the form inputs and submit button.
